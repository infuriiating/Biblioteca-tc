export default {
  ...
  admin: {
    ...
    common: { approve: 'Goedkeuren', reject: 'Afwijzen', returnBtn: 'Inleveren', loadingRequests: 'Aanvragen laden...', fetchingCollection: 'Catalogus laden...', noRequests: 'Geen leningaanvragen gevonden', noBooks: 'Geen boeken gevonden', saveOrder: 'Volgorde opslaan', orderSaved: 'Volgorde succesvol opgeslagen!', orderError: 'Fout bij opslaan volgorde.', select: { placeholder: 'Selecteer een optie...', noOptions: 'Geen opties' } },
