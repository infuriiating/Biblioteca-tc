      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-bg-surface border border-border/60 rounded-3xl shadow-sm p-7 space-y-5">
          <div className="flex items-center gap-3 mb-1">
            ...
            <div>
              <h1 className="text-xl font-semibold text-text-main">Recuperar password</h1>
              <p className="text-xs text-text-muted mt-0.5">Enviaremos um link para o seu email</p>
            </div>
          </div>
              ...
              <div className="bg-green-500/8 border border-green-400/20 p-4 rounded-xl flex items-start gap-3 text-green-400">
                ...
                <div>
                  ...
                  <p className="text-xs mt-1 text-green-400/80">
                    Verifique a sua caixa de entrada em <strong>{email}</strong> e clique no link para redefinir a sua password.
                  </p>
                </div>
              </div>
              <button
